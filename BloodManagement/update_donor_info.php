...
<html>
<title>Donor Info Updation Form</title>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a><center>Donor Info Updation Form</center></a></h1>
		<font size='5.5'face='Black Chancery'color= 'white'>
		<form id="form_444844" class="appnitro"  method="post" action="submit_update_donor_info.php">
		...
		session_start();
		$id = $_SESSION['id'];
		$result= mysql_query("SELECT * FROM donor WHERE national_id=$id");
